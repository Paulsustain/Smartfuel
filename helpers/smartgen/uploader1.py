...
class UploaderClass:
    ...
    def internet_push(self,logs):
        ...
        elif self.upload_type==Upload_type.pm:
            #url='http://api.smarteye.energy360africa.com/api/v1/pm_logger/'
            url='https://api.smarteye.smartflowtech.org/api/v1/pm_logger/'
        else:
            return False
