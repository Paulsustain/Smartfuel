...
#sys.path.append('/home/pi/smarteye/smartgen/sqlite_services')
...
def run_sm():
                                                                                 # if trasmit interval is captured
    try:
        data = sqlite_service.get_unuploaded_dfm_logs()    # assign the unuploaded transaction to variable "data"                                
